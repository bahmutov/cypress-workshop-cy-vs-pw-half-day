...
➡️ Pick the [next section](https://github.com/bahmutov/cypress-workshop-cy-vs-pw-half-day#contents) or jump to the [02-adding-items](?p=02-adding-items) chapter
