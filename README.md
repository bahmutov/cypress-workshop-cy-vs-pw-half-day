# cypress-workshop-cy-vs-pw-half-day

> Cypress Vs Playwright Basics Workshop (Half day)

## Introduction

This workshop teaches you how to write Cypress and Playwright tests using the same hands-on exercises. This workshop is an abridged version of the [bahmutov/cypress-workshop-cy-vs-pw](https://github.com/bahmutov/cypress-workshop-cy-vs-pw).
...
The slides are deployed to GitHub Pages and can be seen at [https://glebbahmutov.com/cypress-workshop-cy-vs-pw-half-day/](https://glebbahmutov.com/cypress-workshop-cy-vs-pw-half-day/).
...
---|---|---|---
Introduction | [intro.md](slides/intro/PITCHME.md) | [link](https://glebbahmutov.com/cypress-workshop-cy-vs-pw-half-day/?p=intro) | [pdf](./pdf/intro.pdf)
Start testing | [00-start.md](slides/00-start/PITCHME.md) | [link](https://glebbahmutov.com/cypress-workshop-cy-vs-pw-half-day/?p=00-start) | [pdf](./pdf/00-start.pdf)
Basic tests | [01-basic.md](slides/01-basic/PITCHME.md) | [link](https://glebbahmutov.com/cypress-workshop-cy-vs-pw-half-day/?p=01-basic) | [pdf](./pdf/01-basic.pdf)
Adding items | [02-adding-items.md](slides/02-adding-items/PITCHME.md) | [link](https://glebbahmutov.com/cypress-workshop-cy-vs-pw-half-day/?p=02-adding-items) | [pdf](./pdf/02-adding-items.pdf)
...
Hover | [05-hover.md](slides/05-hover/PITCHME.md) | [link](https://glebbahmutov.com/cypress-workshop-cy-vs-pw-half-day/?p=05-hover) | [pdf](./pdf/05-hover.pdf)
...
The end | [end](slides/end/PITCHME.md) | [link](https://glebbahmutov.com/cypress-workshop-cy-vs-pw-half-day/?p=end) | [pdf](./pdf/end.pdf)
<!-- prettier-ignore-end -->

## Additional information

- https://github.com/bahmutov/cypress-workshop-cy-vs-pw is the full workshop version, also open source
- https://cypress.tips/
